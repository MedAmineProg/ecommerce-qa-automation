...
const MENU = [
  ...
  { key: "4", label: "Firefox only", npmArgs: ["run", "test:firefox"], logged: true },
  { key: "5", label: "WebKit only", npmArgs: ["run", "test:webkit"], logged: true },
  { key: "6", label: "E2E specs only", npmArgs: ["run", "test:e2e"], logged: true },
  { key: "7", label: "API specs only", npmArgs: ["run", "test:api"], logged: true },
  { key: "8", label: "Unit tests (Jest — squashtm-exporter)", npmArgs: ["run", "test:unit"], logged: true },
  { key: "9", label: "Export to SquashTM (CSV only)", npmArgs: ["run", "export:squashtm"], logged: true },
  {
    key: "10",
  ...
  { key: "11", label: "Interactive UI mode (Playwright)", npmArgs: ["run", "test:ui"], logged: false },
  { key: "12", label: "Codegen (record a new test against the live site)", npmArgs: ["run", "codegen"], logged: false },
  { key: "13", label: "Open last HTML report", npmArgs: ["run", "report"], logged: false },
  { key: "0", label: "Exit" },
];
